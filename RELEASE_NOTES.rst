...
- GAMS implementation of MESSAGE:

  - Fix GDX output file compression on MacOS and Linux (:pull:`965`).
  - Reduce model generation time for scenarios with many nodes (:pull:`1023`, :issue:`1022`).
