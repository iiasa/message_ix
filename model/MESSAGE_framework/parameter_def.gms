...
* engineering parameters
    ...
    flexibility_factor(node,tec,vintage,year_all,mode,commodity,level,time) contribution of technologies towards operation flexibility constraint
    reliability_factor(node,tec,year_all,commodity,level,time,rating)     reliablity of a renewable potential per rating
    reliability_bin(node,tec,year_all,commodity,level,time,rating)        renewable penetration bin size
