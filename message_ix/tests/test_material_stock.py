...
def test_new_params_defined(test_mp):
    ...
    defaults = dict(node_loc="World", node_dest="World", technology="coal_ppl",
                    node_origin="World",
                    commodity="coal", level="end_of_life", year_vtg=2020, time="year",
                    time_origin="year", time_dest="year", value=1, unit="t")
...
def test_new_params_working(test_mp):
    ...
    df_output = dict(node_loc="Westeros", node_dest="Westeros", technology="coal_ppl",
                    node_origin="Westeros",
                    commodity="steel", level="material", year_vtg=[690, 700, 710, 720],
                    time="year",
                    time_origin="year", time_dest="year", value=1, unit="t")
    ...
    # Add steel demand
    df_demand = dict(node="Westeros",
                    commodity="steel", level="material", year=[700, 710, 720],
                    time="year", value=[100, 150, 170], unit="t")
