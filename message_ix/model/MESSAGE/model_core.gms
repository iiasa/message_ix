...
Equations
    ...
    SHARES_GENERIC_UP               upper bounds for generic share constraints
...
* TODO: add docs and LO
SHARES_GENERIC_UP(shares,year,time,type_tec_share,type_tec_total)$(
    share_generic_up(shares,year,time)
)..
    SUM(
	(location,node,tec,vintage,mode,commodity,level,time2)$(
	    (is_input(shares,type_tec_share,location,tec,vintage,year,mode,node,commodity,level,time2,time) OR
	    is_output(shares,type_tec_share,location,tec,vintage,year,mode,node,commodity,level,time2,time)) AND
...
* commodity activity generated by type_tec_share technologies
	    ...
	    is_output(shares,type_tec_share,location,tec,vintage,year,mode,node,commodity,level,time2,time) *
	    output(location,tec,vintage,year,mode,node,commodity,level,time2,time) +
	    is_input(shares,type_tec_share,location,tec,vintage,year,mode,node,commodity,level,time2,time) *
	    input(location,tec,vintage,year,mode,node,commodity,level,time2,time)
	) *
        duration_time_rel(time,time2) *
        ACT(location,tec,vintage,year,mode,time2)
    ...
    SUM(
	(location,node,tec,vintage,mode,commodity,level,time2)$(
	    (is_input(shares,type_tec_total,location,tec,vintage,year,mode,node,commodity,level,time2,time) OR
	    is_output(shares,type_tec_total,location,tec,vintage,year,mode,node,commodity,level,time2,time)) AND
...
* commodity activity generated by type_tec_total technologies
        (
	    is_output(shares,type_tec_total,location,tec,vintage,year,mode,node,commodity,level,time2,time) *
	    output(location,tec,vintage,year,mode,node,commodity,level,time2,time) +
	    is_input(shares,type_tec_total,location,tec,vintage,year,mode,node,commodity,level,time2,time) *
	    input(location,tec,vintage,year,mode,node,commodity,level,time2,time)
	) *
        duration_time_rel(time,time2) *
        ACT(location,tec,vintage,year,mode,time2)
