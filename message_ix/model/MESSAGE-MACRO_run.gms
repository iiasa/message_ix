...
* calculate trade cost detail to show certificate trade
...
* calculate GDP including adjustment for trade ost
GDP.L(node_macro,year) = (I.L(node_macro,year) + C.L(node_macro,year) + EC.L(node_macro,year) - ( trade_cost(node_macro, year) / 1000)) * 1000 ;
